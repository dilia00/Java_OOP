...
public class Pikeman extends Soldier {
    ...
    public Pikeman(int maxHp, int hp, int damage, int maxDamage, int attack,
            int protect, int speed, int x, int y) {
    ...
    public String toString() {
        return String.format("%-6s %-10s %2d %2d %s", name, "Копейщик", speed, hp, state);
